...
function UsuariosTable() {
    ...
    const preencherForm = (item) => {
        ...
        document.getElementById('editarEmail').value = item.email;
        document.getElementById('editarTelefone').value = item.telefone;
        document.getElementById('editarData').value = item.data_de_nascimento;
        document.getElementById('editarCidade').value = item.cidade_onde_nasceu;
        ...
        setFormData({
            ...
            ['cidade_onde_nasceu']: item.cidade_onde_nasceu,
        });
    }
          ...
          <tr>
            ...
            <th>
                <Form.Control
                    ...
                    onChange={e => tableFilter("email", e.target.value)}
                />
            </th>
            <th>
                <Form.Control
                    ...
                    onChange={e => tableFilter("telefone", e.target.value)}
                />
            </th>
            <th>
                <Form.Control
                    ...
                    onChange={e => tableFilter("data_de_nascimento", e.target.value)}
                />
            </th>
            <th>
                <Form.Control
                    type="text"
                    placeholder="Filtrar cidade de nascimento"
                    onChange={e => tableFilter("cidade_onde_nasceu", e.target.value)}
                />
            </th>
            <th></th>
          </tr>
        ...
        <tbody>
            {data.filter(data =>
                ...
                <tr>
                    ...
                    <td>{item.email}</td>
                    <td>{item.telefone}</td>
                    <td>{format(new Date(item.data_de_nascimento), "dd/MM/yyyy")}</td>
                    <td>{item.cidade_onde_nasceu}</td>
                    <td>
                        <div class="row">
                            <div class="col">
                                <Button variant="dark" title='Editar' onClick={() => editForm(item)}>
                            ...
                            <div class="col">
                                <Button variant="dark" title='Excluir' onClick={() => editFormExcluir(item)}>
              ...
              <div class="row">
                  <div class="col">
                      <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                          ...
                          <Form.Control type="email" placeholder="" name='email' id='editarEmail' onChange={editarChange}/>
                      </Form.Group>
                  </div>
              </div>
              <div class="row">
                  <div class="col">
                      <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                          ...
                          <Form.Control type="text" placeholder="" name='telefone' id='editarTelefone' onChange={editarChange}/>
                      </Form.Group>
                  </div>
                  <div class="col">
                      <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                          <Form.Label>Data de nascimento</Form.Label>
                          <Form.Control type="date" placeholder="" name='data_de_nascimento' id='editarData' onChange={editarChange}/>
                      </Form.Group>
                  </div>
              </div>
              <div class="row">
                  <div class="col">
                      <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                          <Form.Label>Cidade onde nascel</Form.Label>
                          <Form.Control type="text" placeholder="" name='cidade_onde_nasceu' id='editarCidade' onChange={editarChange}/>
                      </Form.Group>
                  </div>
              </div>
