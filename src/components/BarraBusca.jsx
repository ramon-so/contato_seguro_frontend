                        ...
                        <div class="row">
                            <div class="col">
                                <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                                    ...
                                    <Form.Control type="email" placeholder="" name='email' onChange={insertChange}/>
                                </Form.Group>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                                    ...
                                    <Form.Control type="text" placeholder="" name='telefone'  onChange={insertChange}/>
                                </Form.Group>
                            </div>
                            <div class="col">
                                <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                                    <Form.Label>Data de nascimento</Form.Label>
                                    <Form.Control type="date" placeholder="" name='data_de_nascimento'  onChange={insertChange}/>
                                </Form.Group>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                                    ...
                                    <Form.Control type="text" placeholder="" name='cidade_onde_nasceu'  onChange={insertChange}/>
                                </Form.Group>
                            </div>
                        </div>
